...
EXP_DIR=$JS/experiment/transcribed/batch1_snp26_repeats
#md $EXP_DIR
cd $EXP_DIR

# Make a fasta file with amplicon reference sequences
REFERENCE=$JS/experiment/transcribed/batch1/reference/batch1_amplicons.fa
...
# to samples.
META=batch1_snp26_repeats.meta.tsv
...
Rscript $JS/src/experiment/getFlashInput.R batch1_snp26_repeats.regions.tsv batch1_snp26_repeats.meta.tsv > batch1_snp26_repeats.flash_input.tsv

sed '1d' batch1_snp26_repeats.flash_input.tsv | submitJobs.py --MEM 1000 --ncores 1 -q normal -j merge_fastq_flash \
...
BAMDIR=bam
sed '1d' batch1_snp26_repeats.flash_input.tsv | cut -f 1,9 | submitJobs.py --MEM 500 --ncores 2 -q yesterday -j align_fastq_flash_amplicon \
