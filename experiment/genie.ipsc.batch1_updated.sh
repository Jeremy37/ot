...
Rscript $JS/src/experiment/getFlashInput.R batch1_updated.regions.ref.tsv $META > batch1_updated.flash_input.tsv

sed '1d' batch1_updated.flash_input.tsv | submitJobs.py --MEM 300 --ncores 1 -q normal -j merge_fastq_flash \
...
BAMDIR=bam_amplicon
sed '1d' batch1_updated.flash_input.tsv | cut -f 1,9 | submitJobs.py --MEM 200 --ncores 2 -q normal -j align_fastq_flash_amplicon \
